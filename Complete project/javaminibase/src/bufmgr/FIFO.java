...
class FIFO extends  Replacer {
    ...
    */
    ...
    {
        super.pin(frameNo);
        if (state_bit[frameNo].state != Pinned) {
            update(frameNo);
        }
    }
    ...
    * @exception BufferPoolExceededException thrown if there are no frames with pin count 0
    */
    ...
    public int pick_victim() throws BufferPoolExceededException
    {
        ...
        //Otherwise, select the first accessed unpinned page
